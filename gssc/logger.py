...
import gssc.metrics_ogb as metrics_ogb
from gssc.metric_wrapper import MetricWrapper
...
class CustomLogger(Logger):
    ...
    def regression(self):
        ...
        if not torch.isnan(pred).any():
            ...
            mae, r2, spearmanr, mse, rmse = float('inf'), float('inf'), float('inf'), float('inf'), float('inf')
        return {'mae': mae, 'r2': r2, 'spearmanr': spearmanr, 'mse': mse, 'rmse': rmse}
