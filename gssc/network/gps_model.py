...
from gssc.encoder.ER_edge_encoder import EREdgeEncoder
from gssc.layer.gps_layer import GPSLayer
from gssc.network.utils import InitPEs
    ...
    def __init__(self, dim_in):
        ...
        if cfg.dataset.edge_encoder:
            ...
            if cfg.dataset.edge_encoder_name == "ER":
                ...
                EdgeEncoder = register.edge_encoder_dict[cfg.dataset.edge_encoder_name[:-3]]
...
class GPSModel(torch.nn.Module):
    ...
    def __init__(self, dim_in, dim_out):
        ...
        if global_model_type == "GSSC":
            self.get_init_pe = InitPEs(cfg.extra.init_pe_dim)
